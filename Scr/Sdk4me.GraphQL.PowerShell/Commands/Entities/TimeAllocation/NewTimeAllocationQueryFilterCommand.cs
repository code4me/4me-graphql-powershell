...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "TimeAllocationQueryFilter")]
    [OutputType(typeof(QueryFilter<TimeAllocationQuery>))]
    public class NewTimeAllocationQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public TimeAllocationFilter Property { get; set; }
        ...
        {
            QueryFilter<TimeAllocationQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewTimeAllocationQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
