...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "RequestQueryFilter")]
    [OutputType(typeof(QueryFilter<RequestQuery>))]
    public class NewRequestQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public RequestFilter Property { get; set; }
        ...
        {
            QueryFilter<RequestQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewRequestQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
