...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "RiskQueryFilter")]
    [OutputType(typeof(QueryFilter<RiskQuery>))]
    public class NewRiskQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public RiskFilter Property { get; set; }
        ...
        {
            QueryFilter<RiskQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewRiskQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
