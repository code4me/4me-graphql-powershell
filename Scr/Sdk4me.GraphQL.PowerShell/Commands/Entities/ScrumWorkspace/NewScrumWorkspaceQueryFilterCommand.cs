...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "ScrumWorkspaceQueryFilter")]
    [OutputType(typeof(QueryFilter<ScrumWorkspaceQuery>))]
    public class NewScrumWorkspaceQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public ScrumWorkspaceFilter Property { get; set; }
        ...
        {
            QueryFilter<ScrumWorkspaceQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewScrumWorkspaceQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
