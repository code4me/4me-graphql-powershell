...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "KnowledgeArticleTemplateQueryFilter")]
    [OutputType(typeof(QueryFilter<KnowledgeArticleTemplateQuery>))]
    public class NewKnowledgeArticleTemplateQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public KnowledgeArticleTemplateFilter Property { get; set; }
        ...
        {
            QueryFilter<KnowledgeArticleTemplateQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewKnowledgeArticleTemplateQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
