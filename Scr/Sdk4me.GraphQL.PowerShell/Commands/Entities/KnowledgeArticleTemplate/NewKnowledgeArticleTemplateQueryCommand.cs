...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "KnowledgeArticleTemplateQuery")]
    [OutputType(typeof(KnowledgeArticleTemplate))]
    public class NewKnowledgeArticleTemplateQueryCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public QueryFilter<KnowledgeArticleTemplateQuery>[] Filters { get; set; } = Array.Empty<QueryFilter<KnowledgeArticleTemplateQuery>>();
        ...
        {
            KnowledgeArticleTemplateQuery retval = ID == null || ID == string.Empty ? new() : new(ID);
            ...
            {
                foreach (QueryFilter<KnowledgeArticleTemplateQuery> filter in Filters)
                {
