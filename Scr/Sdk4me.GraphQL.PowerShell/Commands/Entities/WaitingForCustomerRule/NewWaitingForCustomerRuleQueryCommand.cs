...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "WaitingForCustomerRuleQuery")]
    [OutputType(typeof(WaitingForCustomerRule))]
    public class NewWaitingForCustomerRuleQueryCommand : PSCmdlet
    {
        /// <summary>
        ...
        {
            WaitingForCustomerRuleQuery retval = new();
