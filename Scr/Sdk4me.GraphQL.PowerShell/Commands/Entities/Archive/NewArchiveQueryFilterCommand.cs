...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "ArchiveQueryFilter")]
    [OutputType(typeof(QueryFilter<ArchiveQuery>))]
    public class NewArchiveQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public ArchiveFilter Property { get; set; }
        ...
        {
            QueryFilter<ArchiveQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewArchiveQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
