...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "SprintQuery")]
    [OutputType(typeof(Sprint))]
    public class NewSprintQueryCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public QueryFilter<SprintQuery>[] Filters { get; set; } = Array.Empty<QueryFilter<SprintQuery>>();
        ...
        {
            SprintQuery retval = ID == null || ID == string.Empty ? new() : new(ID);
            ...
            {
                foreach (QueryFilter<SprintQuery> filter in Filters)
                {
