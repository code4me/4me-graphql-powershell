...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "SprintQueryFilter")]
    [OutputType(typeof(QueryFilter<SprintQuery>))]
    public class NewSprintQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public SprintFilter Property { get; set; }
        ...
        {
            QueryFilter<SprintQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewSprintQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
