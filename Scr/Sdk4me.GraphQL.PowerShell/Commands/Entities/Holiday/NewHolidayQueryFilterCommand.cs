...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "HolidayQueryFilter")]
    [OutputType(typeof(QueryFilter<HolidayQuery>))]
    public class NewHolidayQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public HolidayFilter Property { get; set; }
        ...
        {
            QueryFilter<HolidayQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewHolidayQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
