...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "OutOfOfficePeriodQuery")]
    [OutputType(typeof(OutOfOfficePeriod))]
    public class NewOutOfOfficePeriodQueryCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public PersonQuery ApprovalDelegate { get; set; } = new();
        ...
        [ValidateNotNull]
        public QueryFilter<OutOfOfficePeriodQuery>[] Filters { get; set; } = Array.Empty<QueryFilter<OutOfOfficePeriodQuery>>();
        ...
        {
            OutOfOfficePeriodQuery retval = ID == null || ID == string.Empty ? new() : new(ID);
            ...
            if (MyInvocation.BoundParameters.ContainsKey("ApprovalDelegate"))
            {
                retval.SelectApprovalDelegate(ApprovalDelegate);
            }
            ...
            {
                foreach (QueryFilter<OutOfOfficePeriodQuery> filter in Filters)
                {
