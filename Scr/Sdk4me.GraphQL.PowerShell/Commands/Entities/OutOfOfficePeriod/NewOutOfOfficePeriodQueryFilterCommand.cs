...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "OutOfOfficePeriodQueryFilter")]
    [OutputType(typeof(QueryFilter<OutOfOfficePeriodQuery>))]
    public class NewOutOfOfficePeriodQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public OutOfOfficePeriodFilter Property { get; set; }
        ...
        {
            QueryFilter<OutOfOfficePeriodQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewOutOfOfficePeriodQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
