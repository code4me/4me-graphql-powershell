...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "InvoiceQueryFilter")]
    [OutputType(typeof(QueryFilter<InvoiceQuery>))]
    public class NewInvoiceQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public InvoiceFilter Property { get; set; }
        ...
        {
            QueryFilter<InvoiceQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewInvoiceQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
