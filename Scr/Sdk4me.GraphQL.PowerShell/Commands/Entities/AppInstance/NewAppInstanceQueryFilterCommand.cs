...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "AppInstanceQueryFilter")]
    [OutputType(typeof(QueryFilter<AppInstanceQuery>))]
    public class NewAppInstanceQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public AppInstanceFilter Property { get; set; }
        ...
        {
            QueryFilter<AppInstanceQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewAppInstanceQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
