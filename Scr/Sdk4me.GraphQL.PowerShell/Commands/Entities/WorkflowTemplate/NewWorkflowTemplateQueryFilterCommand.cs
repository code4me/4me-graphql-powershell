...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "WorkflowTemplateQueryFilter")]
    [OutputType(typeof(QueryFilter<WorkflowTemplateQuery>))]
    public class NewWorkflowTemplateQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public WorkflowTemplateFilter Property { get; set; }
        ...
        {
            QueryFilter<WorkflowTemplateQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewWorkflowTemplateQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
