...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "WorkflowTypeQueryFilter")]
    [OutputType(typeof(QueryFilter<WorkflowTypeQuery>))]
    public class NewWorkflowTypeQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public WorkflowTypeFilter Property { get; set; }
        ...
        {
            QueryFilter<WorkflowTypeQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewWorkflowTypeQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
