...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "SurveyQuery")]
    [OutputType(typeof(Survey))]
    public class NewSurveyQueryCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public AttachmentQuery CompletionAttachments { get; set; } = new();
        ...
        [ValidateNotNull]
        public AttachmentQuery IntroductionAttachments { get; set; } = new();
        ...
        [ValidateNotNull]
        public SurveyQuestionQuery Questions { get; set; } = new();
        ...
        [ValidateNotNull]
        public QueryFilter<SurveyQuery>[] Filters { get; set; } = Array.Empty<QueryFilter<SurveyQuery>>();
        ...
        {
            SurveyQuery retval = ID == null || ID == string.Empty ? new() : new(ID);
            ...
            if (MyInvocation.BoundParameters.ContainsKey("CompletionAttachments"))
            {
                retval.SelectCompletionAttachments(CompletionAttachments);
            }
            if (MyInvocation.BoundParameters.ContainsKey("IntroductionAttachments"))
            {
                retval.SelectIntroductionAttachments(IntroductionAttachments);
            }
            if (MyInvocation.BoundParameters.ContainsKey("Questions"))
            {
                retval.SelectQuestions(Questions);
            }
            ...
            {
                foreach (QueryFilter<SurveyQuery> filter in Filters)
                {
