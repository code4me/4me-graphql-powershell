...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "SurveyQueryFilter")]
    [OutputType(typeof(QueryFilter<SurveyQuery>))]
    public class NewSurveyQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public SurveyFilter Property { get; set; }
        ...
        {
            QueryFilter<SurveyQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewSurveyQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
