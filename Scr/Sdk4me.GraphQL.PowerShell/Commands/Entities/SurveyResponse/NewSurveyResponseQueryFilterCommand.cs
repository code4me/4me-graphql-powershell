...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "SurveyResponseQueryFilter")]
    [OutputType(typeof(QueryFilter<SurveyResponseQuery>))]
    public class NewSurveyResponseQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public SurveyResponseFilter Property { get; set; }
        ...
        {
            QueryFilter<SurveyResponseQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewSurveyResponseQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
