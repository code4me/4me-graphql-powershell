...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "SurveyResponseQuery")]
    [OutputType(typeof(SurveyResponse))]
    public class NewSurveyResponseQueryCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public SurveyAnswerQuery Answers { get; set; } = new();
        ...
        [ValidateNotNull]
        public QueryFilter<SurveyResponseQuery>[] Filters { get; set; } = Array.Empty<QueryFilter<SurveyResponseQuery>>();
        ...
        {
            SurveyResponseQuery retval = ID == null || ID == string.Empty ? new() : new(ID);
            ...
            if (MyInvocation.BoundParameters.ContainsKey("Answers"))
            {
                retval.SelectAnswers(Answers);
            }
            ...
            {
                foreach (QueryFilter<SurveyResponseQuery> filter in Filters)
                {
