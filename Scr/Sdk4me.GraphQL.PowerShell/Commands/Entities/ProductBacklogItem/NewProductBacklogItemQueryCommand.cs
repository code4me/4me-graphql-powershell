...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "ProductBacklogItemQuery")]
    [OutputType(typeof(ProductBacklogItem))]
    public class NewProductBacklogItemQueryCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public ProductBacklogItemField[] Properties { get; set; } = Array.Empty<ProductBacklogItemField>();
        ...
        {
            ProductBacklogItemQuery retval = new();
