...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "SyncSetQueryFilter")]
    [OutputType(typeof(QueryFilter<SyncSetQuery>))]
    public class NewSyncSetQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public SyncSetFilter Property { get; set; }
        ...
        {
            QueryFilter<SyncSetQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewSyncSetQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
