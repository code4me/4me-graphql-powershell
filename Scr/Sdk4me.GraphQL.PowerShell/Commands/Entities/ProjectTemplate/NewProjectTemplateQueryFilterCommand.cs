...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "ProjectTemplateQueryFilter")]
    [OutputType(typeof(QueryFilter<ProjectTemplateQuery>))]
    public class NewProjectTemplateQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public ProjectTemplateFilter Property { get; set; }
        ...
        {
            QueryFilter<ProjectTemplateQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewProjectTemplateQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
