...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "ProjectTemplateQuery")]
    [OutputType(typeof(ProjectTemplate))]
    public class NewProjectTemplateQueryCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public ProjectTemplatePhaseQuery Phases { get; set; } = new();
        ...
        [ValidateNotNull]
        public ProjectTaskTemplateRelationQuery TaskTemplateRelations { get; set; } = new();
        ...
        [ValidateNotNull]
        public QueryFilter<ProjectTemplateQuery>[] Filters { get; set; } = Array.Empty<QueryFilter<ProjectTemplateQuery>>();
        ...
        {
            ProjectTemplateQuery retval = ID == null || ID == string.Empty ? new() : new(ID);
            ...
            {
                foreach (QueryFilter<ProjectTemplateQuery> filter in Filters)
                {
