...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "RiskSeverityQuery")]
    [OutputType(typeof(RiskSeverity))]
    public class NewRiskSeverityQueryCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public QueryFilter<RiskSeverityQuery>[] Filters { get; set; } = Array.Empty<QueryFilter<RiskSeverityQuery>>();
        ...
        {
            RiskSeverityQuery retval = ID == null || ID == string.Empty ? new() : new(ID);
            ...
            {
                foreach (QueryFilter<RiskSeverityQuery> filter in Filters)
                {
