...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "RiskSeverityQueryFilter")]
    [OutputType(typeof(QueryFilter<RiskSeverityQuery>))]
    public class NewRiskSeverityQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public RiskSeverityFilter Property { get; set; }
        ...
        {
            QueryFilter<RiskSeverityQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewRiskSeverityQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
