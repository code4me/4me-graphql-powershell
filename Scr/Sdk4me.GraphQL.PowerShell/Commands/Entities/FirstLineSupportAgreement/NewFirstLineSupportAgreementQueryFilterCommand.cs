...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "FirstLineSupportAgreementQueryFilter")]
    [OutputType(typeof(QueryFilter<FirstLineSupportAgreementQuery>))]
    public class NewFirstLineSupportAgreementQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public FirstLineSupportAgreementFilter Property { get; set; }
        ...
        {
            QueryFilter<FirstLineSupportAgreementQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewFirstLineSupportAgreementQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
