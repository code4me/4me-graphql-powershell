...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "EffortClassRateIDQuery")]
    [OutputType(typeof(EffortClassRateID))]
    public class NewEffortClassRateIDQueryCommand : PSCmdlet
    {
        /// <summary>
        ...
        {
            EffortClassRateIDQuery retval = new();
