...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "AutomationRuleActionQuery")]
    [OutputType(typeof(AutomationRuleAction))]
    public class NewAutomationRuleActionQueryCommand : PSCmdlet
    {
        /// <summary>
        ...
        {
            AutomationRuleActionQuery retval = new();
