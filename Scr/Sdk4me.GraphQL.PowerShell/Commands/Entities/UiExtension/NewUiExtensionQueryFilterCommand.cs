...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "UiExtensionQueryFilter")]
    [OutputType(typeof(QueryFilter<UiExtensionQuery>))]
    public class NewUiExtensionQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public UiExtensionFilter Property { get; set; }
        ...
        {
            QueryFilter<UiExtensionQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewUiExtensionQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
