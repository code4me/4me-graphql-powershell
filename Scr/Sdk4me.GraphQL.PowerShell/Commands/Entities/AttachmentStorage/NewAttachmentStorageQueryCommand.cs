...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "AttachmentStorageQuery")]
    [OutputType(typeof(AttachmentStorage))]
    public class NewAttachmentStorageQueryCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public QueryFilter<AttachmentStorageQuery>[] Filters { get; set; } = Array.Empty<QueryFilter<AttachmentStorageQuery>>();
        ...
        {
            AttachmentStorageQuery retval = new();
            ...
            {
                foreach (QueryFilter<AttachmentStorageQuery> filter in Filters)
                {
