...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "AttachmentStorageQueryFilter")]
    [OutputType(typeof(QueryFilter<AttachmentStorageQuery>))]
    public class NewAttachmentStorageQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public DefaultFilter Property { get; set; }
        ...
        {
            QueryFilter<AttachmentStorageQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewAttachmentStorageQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
