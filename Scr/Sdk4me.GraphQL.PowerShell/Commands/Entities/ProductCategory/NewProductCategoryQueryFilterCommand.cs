...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "ProductCategoryQueryFilter")]
    [OutputType(typeof(QueryFilter<ProductCategoryQuery>))]
    public class NewProductCategoryQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public ProductCategoryFilter Property { get; set; }
        ...
        {
            QueryFilter<ProductCategoryQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewProductCategoryQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
