...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "SlaNotificationRuleQuery")]
    [OutputType(typeof(SlaNotificationRule))]
    public class NewSlaNotificationRuleQueryCommand : PSCmdlet
    {
        /// <summary>
        ...
        {
            SlaNotificationRuleQuery retval = new();
