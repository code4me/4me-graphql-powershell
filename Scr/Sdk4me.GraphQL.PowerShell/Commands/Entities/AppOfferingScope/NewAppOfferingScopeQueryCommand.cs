...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "AppOfferingScopeQuery")]
    [OutputType(typeof(AppOfferingScope))]
    public class NewAppOfferingScopeQueryCommand : PSCmdlet
    {
        /// <summary>
        ...
        {
            AppOfferingScopeQuery retval = new();
