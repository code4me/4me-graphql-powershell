...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "SiteQueryFilter")]
    [OutputType(typeof(QueryFilter<SiteQuery>))]
    public class NewSiteQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public SiteFilter Property { get; set; }
        ...
        {
            QueryFilter<SiteQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewSiteQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
