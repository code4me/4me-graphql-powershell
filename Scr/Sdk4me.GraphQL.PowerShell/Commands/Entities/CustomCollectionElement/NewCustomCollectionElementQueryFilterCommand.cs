...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "CustomCollectionElementQueryFilter")]
    [OutputType(typeof(QueryFilter<CustomCollectionElementQuery>))]
    public class NewCustomCollectionElementQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public CustomCollectionElementFilter Property { get; set; }
        ...
        {
            QueryFilter<CustomCollectionElementQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewCustomCollectionElementQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
