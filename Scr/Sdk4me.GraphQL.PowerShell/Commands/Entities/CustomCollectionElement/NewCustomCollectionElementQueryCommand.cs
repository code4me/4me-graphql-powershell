...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "CustomCollectionElementQuery")]
    [OutputType(typeof(CustomCollectionElement))]
    public class NewCustomCollectionElementQueryCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public CustomCollectionQuery CustomCollection { get; set; } = new();
        ...
        [ValidateNotNull]
        public QueryFilter<CustomCollectionElementQuery>[] Filters { get; set; } = Array.Empty<QueryFilter<CustomCollectionElementQuery>>();
        ...
        {
            CustomCollectionElementQuery retval = ID == null || ID == string.Empty ? new() : new(ID);
            ...
            {
                retval.SelectCustomCollection(CustomCollection);
            }
            ...
            {
                foreach (QueryFilter<CustomCollectionElementQuery> filter in Filters)
                {
