...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "OrganizationQueryFilter")]
    [OutputType(typeof(QueryFilter<OrganizationQuery>))]
    public class NewOrganizationQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public OrganizationFilter Property { get; set; }
        ...
        {
            QueryFilter<OrganizationQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewOrganizationQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
