...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "AgileBoardColumnQuery")]
    [OutputType(typeof(AgileBoardColumn))]
    public class NewAgileBoardColumnQueryCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public AgileBoardItemQuery Items { get; set; } = new();
        ...
        {
            AgileBoardColumnQuery retval = new();
