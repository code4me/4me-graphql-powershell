...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "ProviderShopArticleQuery")]
    [OutputType(typeof(ProviderShopArticle))]
    public class NewProviderShopArticleQueryCommand : PSCmdlet
    {
        /// <summary>
        ...
        {
            ProviderShopArticleQuery retval = new();
