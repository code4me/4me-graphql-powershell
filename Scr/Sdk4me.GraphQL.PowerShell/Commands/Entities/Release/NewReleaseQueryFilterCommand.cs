...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "ReleaseQueryFilter")]
    [OutputType(typeof(QueryFilter<ReleaseQuery>))]
    public class NewReleaseQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public ReleaseFilter Property { get; set; }
        ...
        {
            QueryFilter<ReleaseQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewReleaseQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
