...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "AutomationRuleQueryFilter")]
    [OutputType(typeof(QueryFilter<AutomationRuleQuery>))]
    public class NewAutomationRuleQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public AutomationRuleFilter Property { get; set; }
        ...
        {
            QueryFilter<AutomationRuleQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewAutomationRuleQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
