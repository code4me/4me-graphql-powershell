...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "ShopArticleQueryFilter")]
    [OutputType(typeof(QueryFilter<ShopArticleQuery>))]
    public class NewShopArticleQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public ShopArticleFilter Property { get; set; }
        ...
        {
            QueryFilter<ShopArticleQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewShopArticleQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
