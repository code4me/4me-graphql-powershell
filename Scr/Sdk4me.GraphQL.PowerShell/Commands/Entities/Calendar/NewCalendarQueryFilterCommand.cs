...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "CalendarQueryFilter")]
    [OutputType(typeof(QueryFilter<CalendarQuery>))]
    public class NewCalendarQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public CalendarFilter Property { get; set; }
        ...
        {
            QueryFilter<CalendarQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewCalendarQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
