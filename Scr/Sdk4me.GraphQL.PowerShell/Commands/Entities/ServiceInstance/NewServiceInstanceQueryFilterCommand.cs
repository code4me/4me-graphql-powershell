...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "ServiceInstanceQueryFilter")]
    [OutputType(typeof(QueryFilter<ServiceInstanceQuery>))]
    public class NewServiceInstanceQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public ServiceInstanceFilter Property { get; set; }
        ...
        {
            QueryFilter<ServiceInstanceQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewServiceInstanceQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
