...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "TaskQueryFilter")]
    [OutputType(typeof(QueryFilter<TaskQuery>))]
    public class NewTaskQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public TaskFilter Property { get; set; }
        ...
        {
            QueryFilter<TaskQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewTaskQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
