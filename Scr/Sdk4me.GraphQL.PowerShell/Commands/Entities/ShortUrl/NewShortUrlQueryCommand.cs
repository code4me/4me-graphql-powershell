...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "ShortUrlQuery")]
    [OutputType(typeof(ShortUrl))]
    public class NewShortUrlQueryCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public QueryFilter<ShortUrlQuery>[] Filters { get; set; } = Array.Empty<QueryFilter<ShortUrlQuery>>();
        ...
        {
            ShortUrlQuery retval = ID == null || ID == string.Empty ? new() : new(ID);
            ...
            {
                foreach (QueryFilter<ShortUrlQuery> filter in Filters)
                {
