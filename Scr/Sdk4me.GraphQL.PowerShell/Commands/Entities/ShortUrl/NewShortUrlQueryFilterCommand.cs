...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "ShortUrlQueryFilter")]
    [OutputType(typeof(QueryFilter<ShortUrlQuery>))]
    public class NewShortUrlQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public ShortUrlFilter Property { get; set; }
        ...
        {
            QueryFilter<ShortUrlQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewShortUrlQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
