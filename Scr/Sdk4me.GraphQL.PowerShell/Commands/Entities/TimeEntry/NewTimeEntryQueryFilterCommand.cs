...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "TimeEntryQueryFilter")]
    [OutputType(typeof(QueryFilter<TimeEntryQuery>))]
    public class NewTimeEntryQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public TimeEntryFilter Property { get; set; }
        ...
        {
            QueryFilter<TimeEntryQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewTimeEntryQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
