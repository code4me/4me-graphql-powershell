...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "ProjectQueryFilter")]
    [OutputType(typeof(QueryFilter<ProjectQuery>))]
    public class NewProjectQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public ProjectFilter Property { get; set; }
        ...
        {
            QueryFilter<ProjectQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewProjectQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
