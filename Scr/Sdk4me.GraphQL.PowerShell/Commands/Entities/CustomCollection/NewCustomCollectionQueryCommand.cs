...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "CustomCollectionQuery")]
    [OutputType(typeof(CustomCollection))]
    public class NewCustomCollectionQueryCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public CustomCollectionElementQuery CollectionElements { get; set; } = new();
        ...
        [ValidateNotNull]
        public QueryFilter<CustomCollectionQuery>[] Filters { get; set; } = Array.Empty<QueryFilter<CustomCollectionQuery>>();
        ...
        {
            CustomCollectionQuery retval = ID == null || ID == string.Empty ? new() : new(ID);
            ...
            if (MyInvocation.BoundParameters.ContainsKey("CollectionElements"))
            {
                retval.SelectCollectionElements(CollectionElements);
            }
            ...
            {
                foreach (QueryFilter<CustomCollectionQuery> filter in Filters)
                {
