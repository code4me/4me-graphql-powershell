...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "CustomCollectionQueryFilter")]
    [OutputType(typeof(QueryFilter<CustomCollectionQuery>))]
    public class NewCustomCollectionQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public CustomCollectionFilter Property { get; set; }
        ...
        {
            QueryFilter<CustomCollectionQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewCustomCollectionQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
