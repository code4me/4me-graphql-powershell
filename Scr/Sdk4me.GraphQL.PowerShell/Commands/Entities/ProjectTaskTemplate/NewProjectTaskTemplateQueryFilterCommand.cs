...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "ProjectTaskTemplateQueryFilter")]
    [OutputType(typeof(QueryFilter<ProjectTaskTemplateQuery>))]
    public class NewProjectTaskTemplateQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public ProjectTaskTemplateFilter Property { get; set; }
        ...
        {
            QueryFilter<ProjectTaskTemplateQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewProjectTaskTemplateQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
