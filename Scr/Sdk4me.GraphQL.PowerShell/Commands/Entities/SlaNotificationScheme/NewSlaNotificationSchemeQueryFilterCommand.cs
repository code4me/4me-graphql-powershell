...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "SlaNotificationSchemeQueryFilter")]
    [OutputType(typeof(QueryFilter<SlaNotificationSchemeQuery>))]
    public class NewSlaNotificationSchemeQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public SlaNotificationSchemeFilter Property { get; set; }
        ...
        {
            QueryFilter<SlaNotificationSchemeQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewSlaNotificationSchemeQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
