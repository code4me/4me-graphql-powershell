...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "SlaNotificationSchemeQuery")]
    [OutputType(typeof(SlaNotificationScheme))]
    public class NewSlaNotificationSchemeQueryCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public SlaNotificationRuleQuery SlaNotificationRules { get; set; } = new();
        ...
        [ValidateNotNull]
        public QueryFilter<SlaNotificationSchemeQuery>[] Filters { get; set; } = Array.Empty<QueryFilter<SlaNotificationSchemeQuery>>();
        ...
        {
            SlaNotificationSchemeQuery retval = ID == null || ID == string.Empty ? new() : new(ID);
            ...
            if (MyInvocation.BoundParameters.ContainsKey("SlaNotificationRules"))
            {
                retval.SelectSlaNotificationRules(SlaNotificationRules);
            }

            if (MyInvocation.BoundParameters.ContainsKey("Filters"))
            {
                foreach (QueryFilter<SlaNotificationSchemeQuery> filter in Filters)
                {
