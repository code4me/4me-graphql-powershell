...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "TranslationQueryFilter")]
    [OutputType(typeof(QueryFilter<TranslationQuery>))]
    public class NewTranslationQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public TranslationFilter Property { get; set; }
        ...
        {
            QueryFilter<TranslationQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewTranslationQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
