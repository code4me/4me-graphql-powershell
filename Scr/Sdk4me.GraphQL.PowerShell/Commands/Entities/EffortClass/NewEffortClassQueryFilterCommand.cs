...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "EffortClassQueryFilter")]
    [OutputType(typeof(QueryFilter<EffortClassQuery>))]
    public class NewEffortClassQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public EffortClassFilter Property { get; set; }
        ...
        {
            QueryFilter<EffortClassQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewEffortClassQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
