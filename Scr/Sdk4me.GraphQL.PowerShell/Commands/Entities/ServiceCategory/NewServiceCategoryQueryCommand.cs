...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "ServiceCategoryQuery")]
    [OutputType(typeof(ServiceCategory))]
    public class NewServiceCategoryQueryCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public QueryFilter<ServiceCategoryQuery>[] Filters { get; set; } = Array.Empty<QueryFilter<ServiceCategoryQuery>>();
        ...
        {
            ServiceCategoryQuery retval = ID == null || ID == string.Empty ? new() : new(ID);
            ...
            {
                foreach (QueryFilter<ServiceCategoryQuery> filter in Filters)
                {
