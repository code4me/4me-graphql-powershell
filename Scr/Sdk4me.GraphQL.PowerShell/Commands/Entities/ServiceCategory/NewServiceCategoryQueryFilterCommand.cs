...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "ServiceCategoryQueryFilter")]
    [OutputType(typeof(QueryFilter<ServiceCategoryQuery>))]
    public class NewServiceCategoryQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public ServiceCategoryFilter Property { get; set; }
        ...
        {
            QueryFilter<ServiceCategoryQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewServiceCategoryQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
