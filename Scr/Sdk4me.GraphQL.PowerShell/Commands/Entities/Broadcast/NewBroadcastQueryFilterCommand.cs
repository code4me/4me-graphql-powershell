...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "BroadcastQueryFilter")]
    [OutputType(typeof(QueryFilter<BroadcastQuery>))]
    public class NewBroadcastQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public BroadcastFilter Property { get; set; }
        ...
        {
            QueryFilter<BroadcastQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewBroadcastQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
