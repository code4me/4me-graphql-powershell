...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "AffectedSlaQueryFilter")]
    [OutputType(typeof(QueryFilter<AffectedSlaQuery>))]
    public class NewAffectedSlaQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public AffectedSlaFilter Property { get; set; }
        ...
        {
            QueryFilter<AffectedSlaQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewAffectedSlaQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
