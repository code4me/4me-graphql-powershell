...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "TimesheetSettingQueryFilter")]
    [OutputType(typeof(QueryFilter<TimesheetSettingQuery>))]
    public class NewTimesheetSettingQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public TimesheetSettingFilter Property { get; set; }
        ...
        {
            QueryFilter<TimesheetSettingQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewTimesheetSettingQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
