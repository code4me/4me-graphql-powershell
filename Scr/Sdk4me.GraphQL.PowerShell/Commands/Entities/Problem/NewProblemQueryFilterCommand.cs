...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "ProblemQueryFilter")]
    [OutputType(typeof(QueryFilter<ProblemQuery>))]
    public class NewProblemQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public ProblemFilter Property { get; set; }
        ...
        {
            QueryFilter<ProblemQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewProblemQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
