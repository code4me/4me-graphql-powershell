...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "TrashQueryFilter")]
    [OutputType(typeof(QueryFilter<TrashQuery>))]
    public class NewTrashQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public TrashFilter Property { get; set; }
        ...
        {
            QueryFilter<TrashQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewTrashQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
