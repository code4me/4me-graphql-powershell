...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "ProductQueryFilter")]
    [OutputType(typeof(QueryFilter<ProductQuery>))]
    public class NewProductQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public ProductFilter Property { get; set; }
        ...
        {
            QueryFilter<ProductQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewProductQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
