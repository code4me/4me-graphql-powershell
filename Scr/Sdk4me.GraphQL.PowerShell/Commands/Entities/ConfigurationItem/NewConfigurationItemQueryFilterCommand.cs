...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "ConfigurationItemQueryFilter")]
    [OutputType(typeof(QueryFilter<ConfigurationItemQuery>))]
    public class NewConfigurationItemQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public ConfigurationItemFilter Property { get; set; }
        ...
        {
            QueryFilter<ConfigurationItemQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewConfigurationItemQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
