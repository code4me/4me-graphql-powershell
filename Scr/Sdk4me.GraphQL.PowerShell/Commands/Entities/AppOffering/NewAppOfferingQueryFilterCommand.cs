...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "AppOfferingQueryFilter")]
    [OutputType(typeof(QueryFilter<AppOfferingQuery>))]
    public class NewAppOfferingQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public AppOfferingFilter Property { get; set; }
        ...
        {
            QueryFilter<AppOfferingQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewAppOfferingQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
