...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "ParentServiceInstanceQuery")]
    [OutputType(typeof(ParentServiceInstance))]
    public class NewParentServiceInstanceQueryCommand : PSCmdlet
    {
        /// <summary>
        ...
        {
            ParentServiceInstanceQuery retval = new();
