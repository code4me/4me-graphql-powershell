...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "WebhookPolicyQuery")]
    [OutputType(typeof(WebhookPolicy))]
    public class NewWebhookPolicyQueryCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public QueryFilter<WebhookPolicyQuery>[] Filters { get; set; } = Array.Empty<QueryFilter<WebhookPolicyQuery>>();
        ...
        {
            WebhookPolicyQuery retval = ID == null || ID == string.Empty ? new() : new(ID);
            ...
            {
                foreach (QueryFilter<WebhookPolicyQuery> filter in Filters)
                {
