...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "WebhookPolicyQueryFilter")]
    [OutputType(typeof(QueryFilter<WebhookPolicyQuery>))]
    public class NewWebhookPolicyQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public WebhookPolicyFilter Property { get; set; }
        ...
        {
            QueryFilter<WebhookPolicyQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewWebhookPolicyQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
