...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "ContractQueryFilter")]
    [OutputType(typeof(QueryFilter<ContractQuery>))]
    public class NewContractQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public ContractFilter Property { get; set; }
        ...
        {
            QueryFilter<ContractQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewContractQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
