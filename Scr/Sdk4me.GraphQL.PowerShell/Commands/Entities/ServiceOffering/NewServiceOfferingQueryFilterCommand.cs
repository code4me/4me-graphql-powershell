...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "ServiceOfferingQueryFilter")]
    [OutputType(typeof(QueryFilter<ServiceOfferingQuery>))]
    public class NewServiceOfferingQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public ServiceOfferingFilter Property { get; set; }
        ...
        {
            QueryFilter<ServiceOfferingQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewServiceOfferingQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
