...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "ProjectRiskLevelQueryFilter")]
    [OutputType(typeof(QueryFilter<ProjectRiskLevelQuery>))]
    public class NewProjectRiskLevelQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public ProjectRiskLevelFilter Property { get; set; }
        ...
        {
            QueryFilter<ProjectRiskLevelQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewProjectRiskLevelQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
