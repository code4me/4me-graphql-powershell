...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "ProjectRiskLevelQuery")]
    [OutputType(typeof(ProjectRiskLevel))]
    public class NewProjectRiskLevelQueryCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public QueryFilter<ProjectRiskLevelQuery>[] Filters { get; set; } = Array.Empty<QueryFilter<ProjectRiskLevelQuery>>();
        ...
        {
            ProjectRiskLevelQuery retval = ID == null || ID == string.Empty ? new() : new(ID);
            ...
            {
                foreach (QueryFilter<ProjectRiskLevelQuery> filter in Filters)
                {
