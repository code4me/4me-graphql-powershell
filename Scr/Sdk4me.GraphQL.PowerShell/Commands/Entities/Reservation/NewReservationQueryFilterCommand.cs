...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "ReservationQueryFilter")]
    [OutputType(typeof(QueryFilter<ReservationQuery>))]
    public class NewReservationQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public ReservationFilter Property { get; set; }
        ...
        {
            QueryFilter<ReservationQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewReservationQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
