...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "TeamQueryFilter")]
    [OutputType(typeof(QueryFilter<TeamQuery>))]
    public class NewTeamQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public TeamFilter Property { get; set; }
        ...
        {
            QueryFilter<TeamQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewTeamQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
