...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "WaitingForCustomerFollowUpQueryFilter")]
    [OutputType(typeof(QueryFilter<WaitingForCustomerFollowUpQuery>))]
    public class NewWaitingForCustomerFollowUpQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public WaitingForCustomerFollowUpFilter Property { get; set; }
        ...
        {
            QueryFilter<WaitingForCustomerFollowUpQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewWaitingForCustomerFollowUpQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
