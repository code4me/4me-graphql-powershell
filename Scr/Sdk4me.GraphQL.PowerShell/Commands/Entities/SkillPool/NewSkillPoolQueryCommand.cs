...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "SkillPoolQuery")]
    [OutputType(typeof(SkillPool))]
    public class NewSkillPoolQueryCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public QueryFilter<SkillPoolQuery>[] Filters { get; set; } = Array.Empty<QueryFilter<SkillPoolQuery>>();
        ...
        {
            SkillPoolQuery retval = ID == null || ID == string.Empty ? new() : new(ID);
            ...
            {
                foreach (QueryFilter<SkillPoolQuery> filter in Filters)
                {
