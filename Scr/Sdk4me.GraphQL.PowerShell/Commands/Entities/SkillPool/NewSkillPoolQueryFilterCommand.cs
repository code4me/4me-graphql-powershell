...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "SkillPoolQueryFilter")]
    [OutputType(typeof(QueryFilter<SkillPoolQuery>))]
    public class NewSkillPoolQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public SkillPoolFilter Property { get; set; }
        ...
        {
            QueryFilter<SkillPoolQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewSkillPoolQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
