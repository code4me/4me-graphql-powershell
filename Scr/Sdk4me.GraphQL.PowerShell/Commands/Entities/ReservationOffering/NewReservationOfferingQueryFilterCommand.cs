...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "ReservationOfferingQueryFilter")]
    [OutputType(typeof(QueryFilter<ReservationOfferingQuery>))]
    public class NewReservationOfferingQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public ReservationOfferingFilter Property { get; set; }
        ...
        {
            QueryFilter<ReservationOfferingQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewReservationOfferingQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
