...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "ReservationOfferingQuery")]
    [OutputType(typeof(ReservationOffering))]
    public class NewReservationOfferingQueryCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public RequestTemplateQuery RequestTemplates { get; set; } = new();
        ...
        [ValidateNotNull]
        public QueryFilter<ReservationOfferingQuery>[] Filters { get; set; } = Array.Empty<QueryFilter<ReservationOfferingQuery>>();
        ...
        {
            ReservationOfferingQuery retval = ID == null || ID == string.Empty ? new() : new(ID);
            ...
            if (MyInvocation.BoundParameters.ContainsKey("RequestTemplates"))
            {
                retval.SelectRequestTemplates(RequestTemplates);
            }
            ...
            {
                foreach (QueryFilter<ReservationOfferingQuery> filter in Filters)
                {
