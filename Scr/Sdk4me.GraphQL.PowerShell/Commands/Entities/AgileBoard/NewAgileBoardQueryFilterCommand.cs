...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "AgileBoardQueryFilter")]
    [OutputType(typeof(QueryFilter<AgileBoardQuery>))]
    public class NewAgileBoardQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public AgileBoardFilter Property { get; set; }
        ...
        {
            QueryFilter<AgileBoardQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewAgileBoardQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
