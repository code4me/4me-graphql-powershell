...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "AgileBoardQuery")]
    [OutputType(typeof(AgileBoard))]
    public class NewAgileBoardQueryCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public AgileBoardColumnQuery Columns { get; set; } = new();
        ...
        [ValidateNotNull]
        public SprintQuery CurrentSprint { get; set; } = new();
        ...
        [ValidateNotNull]
        public ServiceLevelAgreementQuery CustomerRepresentativeSlas { get; set; } = new();
        ...
        [ValidateNotNull]
        public QueryFilter<AgileBoardQuery>[] Filters { get; set; } = Array.Empty<QueryFilter<AgileBoardQuery>>();
        ...
        {
            AgileBoardQuery retval = ID == null || ID == string.Empty ? new() : new(ID);
            ...
            {
                retval.SelectColumns(Columns);
            }
            if (MyInvocation.BoundParameters.ContainsKey("CurrentSprint"))
            {
                retval.SelectCurrentSprint(CurrentSprint);
            }
            if (MyInvocation.BoundParameters.ContainsKey("CustomerRepresentativeSlas"))
            {
                retval.SelectCustomerRepresentativeSlas(CustomerRepresentativeSlas);
            }
            ...
            {
                foreach (QueryFilter<AgileBoardQuery> filter in Filters)
                {
