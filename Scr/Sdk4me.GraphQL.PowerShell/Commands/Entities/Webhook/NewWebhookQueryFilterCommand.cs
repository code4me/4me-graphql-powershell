...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "WebhookQueryFilter")]
    [OutputType(typeof(QueryFilter<WebhookQuery>))]
    public class NewWebhookQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public WebhookFilter Property { get; set; }
        ...
        {
            QueryFilter<WebhookQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewWebhookQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
