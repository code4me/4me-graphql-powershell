...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "WebhookQuery")]
    [OutputType(typeof(Webhook))]
    public class NewWebhookQueryCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public QueryFilter<WebhookQuery>[] Filters { get; set; } = Array.Empty<QueryFilter<WebhookQuery>>();
        ...
        {
            WebhookQuery retval = ID == null || ID == string.Empty ? new() : new(ID);
            ...
            {
                foreach (QueryFilter<WebhookQuery> filter in Filters)
                {
