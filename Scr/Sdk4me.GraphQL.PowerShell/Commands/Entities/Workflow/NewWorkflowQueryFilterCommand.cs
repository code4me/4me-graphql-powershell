...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "WorkflowQueryFilter")]
    [OutputType(typeof(QueryFilter<WorkflowQuery>))]
    public class NewWorkflowQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public WorkflowFilter Property { get; set; }
        ...
        {
            QueryFilter<WorkflowQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewWorkflowQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
