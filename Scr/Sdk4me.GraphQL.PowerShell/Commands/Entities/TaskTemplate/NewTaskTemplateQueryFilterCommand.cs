...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "TaskTemplateQueryFilter")]
    [OutputType(typeof(QueryFilter<TaskTemplateQuery>))]
    public class NewTaskTemplateQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public TaskTemplateFilter Property { get; set; }
        ...
        {
            QueryFilter<TaskTemplateQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewTaskTemplateQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
