...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "ServiceLevelAgreementQueryFilter")]
    [OutputType(typeof(QueryFilter<ServiceLevelAgreementQuery>))]
    public class NewServiceLevelAgreementQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public ServiceLevelAgreementFilter Property { get; set; }
        ...
        {
            QueryFilter<ServiceLevelAgreementQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewServiceLevelAgreementQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
