...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "ServiceQueryFilter")]
    [OutputType(typeof(QueryFilter<ServiceQuery>))]
    public class NewServiceQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public ServiceFilter Property { get; set; }
        ...
        {
            QueryFilter<ServiceQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewServiceQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
