...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "PdfDesignQuery")]
    [OutputType(typeof(PdfDesign))]
    public class NewPdfDesignQueryCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public QueryFilter<PdfDesignQuery>[] Filters { get; set; } = Array.Empty<QueryFilter<PdfDesignQuery>>();
        ...
        {
            PdfDesignQuery retval = ID == null || ID == string.Empty ? new() : new(ID);
            ...
            {
                foreach (QueryFilter<PdfDesignQuery> filter in Filters)
                {
