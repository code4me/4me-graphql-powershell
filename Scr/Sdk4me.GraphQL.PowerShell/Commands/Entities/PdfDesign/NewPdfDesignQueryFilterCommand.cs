...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "PdfDesignQueryFilter")]
    [OutputType(typeof(QueryFilter<PdfDesignQuery>))]
    public class NewPdfDesignQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public PdfDesignFilter Property { get; set; }
        ...
        {
            QueryFilter<PdfDesignQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewPdfDesignQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
