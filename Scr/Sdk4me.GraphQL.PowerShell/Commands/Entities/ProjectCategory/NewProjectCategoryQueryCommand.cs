...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "ProjectCategoryQuery")]
    [OutputType(typeof(ProjectCategory))]
    public class NewProjectCategoryQueryCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public QueryFilter<ProjectCategoryQuery>[] Filters { get; set; } = Array.Empty<QueryFilter<ProjectCategoryQuery>>();
        ...
        {
            ProjectCategoryQuery retval = ID == null || ID == string.Empty ? new() : new(ID);
            ...
            {
                foreach (QueryFilter<ProjectCategoryQuery> filter in Filters)
                {
