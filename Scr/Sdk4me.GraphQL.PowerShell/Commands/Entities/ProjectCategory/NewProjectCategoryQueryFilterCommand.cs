...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "ProjectCategoryQueryFilter")]
    [OutputType(typeof(QueryFilter<ProjectCategoryQuery>))]
    public class NewProjectCategoryQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public ProjectCategoryFilter Property { get; set; }
        ...
        {
            QueryFilter<ProjectCategoryQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewProjectCategoryQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
