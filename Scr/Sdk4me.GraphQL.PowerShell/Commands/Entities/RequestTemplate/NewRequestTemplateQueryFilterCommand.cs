...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "RequestTemplateQueryFilter")]
    [OutputType(typeof(QueryFilter<RequestTemplateQuery>))]
    public class NewRequestTemplateQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public RequestTemplateFilter Property { get; set; }
        ...
        {
            QueryFilter<RequestTemplateQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewRequestTemplateQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
