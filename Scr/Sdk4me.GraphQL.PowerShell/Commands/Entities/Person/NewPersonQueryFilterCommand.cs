...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "PersonQueryFilter")]
    [OutputType(typeof(QueryFilter<PersonQuery>))]
    public class NewPersonQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public PersonFilter Property { get; set; }
        ...
        {
            QueryFilter<PersonQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewPersonQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
