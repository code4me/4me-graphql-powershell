...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "PersonQuery")]
    [OutputType(typeof(Person))]
    public class NewPersonQueryCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public QueryFilter<PersonQuery>[] Filters { get; set; } = Array.Empty<QueryFilter<PersonQuery>>();
        ...
        {
            PersonQuery retval = ID == null || ID == string.Empty ? new() : new(ID);
            ...
            {
                foreach (QueryFilter<PersonQuery> filter in Filters)
                {
