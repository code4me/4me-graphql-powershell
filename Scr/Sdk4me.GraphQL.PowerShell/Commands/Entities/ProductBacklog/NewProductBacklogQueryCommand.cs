...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "ProductBacklogQuery")]
    [OutputType(typeof(ProductBacklog))]
    public class NewProductBacklogQueryCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public ProductBacklogItemQuery Items { get; set; } = new();
        ...
        [ValidateNotNull]
        public PersonQuery ProductOwner { get; set; } = new();
        ...
        [ValidateNotNull]
        public ScrumWorkspaceQuery ScrumWorkspaces { get; set; } = new();
        ...
        [ValidateNotNull]
        public QueryFilter<ProductBacklogQuery>[] Filters { get; set; } = Array.Empty<QueryFilter<ProductBacklogQuery>>();
        ...
        {
            ProductBacklogQuery retval = ID == null || ID == string.Empty ? new() : new(ID);
            ...
            if (MyInvocation.BoundParameters.ContainsKey("Items"))
            {
                retval.SelectItems(Items);
            }
            if (MyInvocation.BoundParameters.ContainsKey("ProductOwner"))
            {
                retval.SelectProductOwner(ProductOwner);
            }
            if (MyInvocation.BoundParameters.ContainsKey("ScrumWorkspaces"))
            {
                retval.SelectScrumWorkspaces(ScrumWorkspaces);
            }

            if (MyInvocation.BoundParameters.ContainsKey("Filters"))
            {
                foreach (QueryFilter<ProductBacklogQuery> filter in Filters)
                {
