...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "ProductBacklogQueryFilter")]
    [OutputType(typeof(QueryFilter<ProductBacklogQuery>))]
    public class NewProductBacklogQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public ProductBacklogFilter Property { get; set; }
        ...
        {
            QueryFilter<ProductBacklogQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewProductBacklogQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
