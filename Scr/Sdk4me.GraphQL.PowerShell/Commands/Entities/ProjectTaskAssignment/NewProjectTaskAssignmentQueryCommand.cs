...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "ProjectTaskAssignmentQuery")]
    [OutputType(typeof(ProjectTaskAssignment))]
    public class NewProjectTaskAssignmentQueryCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public PersonQuery Assignee { get; set; } = new();
        ...
        {
            ProjectTaskAssignmentQuery retval = new();

            if (MyInvocation.BoundParameters.ContainsKey("Assignee"))
            {
                retval.SelectAssignee(Assignee);
            }
