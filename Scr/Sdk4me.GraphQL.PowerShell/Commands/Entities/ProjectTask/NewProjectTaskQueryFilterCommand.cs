...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "ProjectTaskQueryFilter")]
    [OutputType(typeof(QueryFilter<ProjectTaskQuery>))]
    public class NewProjectTaskQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public ProjectTaskFilter Property { get; set; }
        ...
        {
            QueryFilter<ProjectTaskQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewProjectTaskQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
