...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "ShopArticleCategoryQueryFilter")]
    [OutputType(typeof(QueryFilter<ShopArticleCategoryQuery>))]
    public class NewShopArticleCategoryQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public ShopArticleCategoryFilter Property { get; set; }
        ...
        {
            QueryFilter<ShopArticleCategoryQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewShopArticleCategoryQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
