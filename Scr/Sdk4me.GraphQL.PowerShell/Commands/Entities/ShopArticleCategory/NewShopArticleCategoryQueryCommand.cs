...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "ShopArticleCategoryQuery")]
    [OutputType(typeof(ShopArticleCategory))]
    public class NewShopArticleCategoryQueryCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public AttachmentQuery FullDescriptionAttachments { get; set; } = new();
        ...
        [ValidateNotNull]
        public ShopArticleCategoryQuery Parent { get; set; } = new();
        ...
        [ValidateNotNull]
        public QueryFilter<ShopArticleCategoryQuery>[] Filters { get; set; } = Array.Empty<QueryFilter<ShopArticleCategoryQuery>>();
        ...
        {
            ShopArticleCategoryQuery retval = ID == null || ID == string.Empty ? new() : new(ID);
            ...
            {
                retval.SelectFullDescriptionAttachments(FullDescriptionAttachments);
            }
            if (MyInvocation.BoundParameters.ContainsKey("Parent"))
            {
                retval.SelectParent(Parent);
            }
            ...
            {
                foreach (QueryFilter<ShopArticleCategoryQuery> filter in Filters)
                {
