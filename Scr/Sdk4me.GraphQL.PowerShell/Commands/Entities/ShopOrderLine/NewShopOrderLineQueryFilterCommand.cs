...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "ShopOrderLineQueryFilter")]
    [OutputType(typeof(QueryFilter<ShopOrderLineQuery>))]
    public class NewShopOrderLineQueryFilterCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public ShopOrderLineFilter Property { get; set; }
        ...
        {
            QueryFilter<ShopOrderLineQuery> filter = new(Property.GetEnumMemberValue(), Operator)
            {
            ...
            {
                new Sdk4meFilterException(errorMessage).ThrowAsTerminatingError(this, "NewShopOrderLineQueryFilterError", ErrorCategory.InvalidArgument, this);
            }
        }
