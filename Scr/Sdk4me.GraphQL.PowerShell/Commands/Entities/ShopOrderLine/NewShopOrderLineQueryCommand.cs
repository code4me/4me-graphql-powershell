...
namespace Sdk4me.GraphQL.PowerShell.Commands
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "ShopOrderLineQuery")]
    [OutputType(typeof(ShopOrderLine))]
    public class NewShopOrderLineQueryCommand : PSCmdlet
    {
        /// <summary>
        ...
        [ValidateNotNull]
        public RequestQuery FulfillmentRequest { get; set; } = new();
        ...
        [ValidateNotNull]
        public TaskQuery FulfillmentTask { get; set; } = new();
        ...
        [ValidateNotNull]
        public RequestTemplateQuery FulfillmentTemplate { get; set; } = new();
        ...
        [ValidateNotNull]
        public RequestQuery Order { get; set; } = new();
        ...
        [ValidateNotNull]
        public ProviderShopOrderLineQuery ProviderOrderLine { get; set; } = new();
        ...
        [ValidateNotNull]
        public ShopArticleQuery ShopArticle { get; set; } = new();
        ...
        [ValidateNotNull]
        public QueryFilter<ShopOrderLineQuery>[] Filters { get; set; } = Array.Empty<QueryFilter<ShopOrderLineQuery>>();
        ...
        {
            ShopOrderLineQuery retval = ID == null || ID == string.Empty ? new() : new(ID);
            ...
            if (MyInvocation.BoundParameters.ContainsKey("FulfillmentRequest"))
            {
                retval.SelectFulfillmentRequest(FulfillmentRequest);
            }
            if (MyInvocation.BoundParameters.ContainsKey("FulfillmentTask"))
            {
                retval.SelectFulfillmentTask(FulfillmentTask);
            }
            if (MyInvocation.BoundParameters.ContainsKey("FulfillmentTemplate"))
            {
                retval.SelectFulfillmentTemplate(FulfillmentTemplate);
            }
            if (MyInvocation.BoundParameters.ContainsKey("Order"))
            {
                retval.SelectOrder(Order);
            }
            if (MyInvocation.BoundParameters.ContainsKey("ProviderOrderLine"))
            {
                retval.SelectProviderOrderLine(ProviderOrderLine);
            }
            ...
            if (MyInvocation.BoundParameters.ContainsKey("ShopArticle"))
            {
                retval.SelectShopArticle(ShopArticle);
            }

            if (MyInvocation.BoundParameters.ContainsKey("Filters"))
            {
                foreach (QueryFilter<ShopOrderLineQuery> filter in Filters)
                {
